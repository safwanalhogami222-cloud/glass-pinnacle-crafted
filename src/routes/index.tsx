...
const WHY = [
  { icon: Search, title: "دقة القياس", desc: "نبدأ كل مشروع بقياسات دقيقة لضمان تركيب متقن ونتيجة نهائية تليق بتوقعات العميل." },
  { icon: ShieldCheck, title: "جودة التنفيذ", desc: "نهتم بكل مرحلة من مراحل التنفيذ، من اختيار المواد حتى التشطيب النهائي، لضمان جودة العمل." },
  { icon: Sparkles, title: "حلول مخصصة", desc: "نوفر حلولًا تناسب المنازل والفلل والمنشآت التجارية وفق احتياجات كل مشروع." },
  { icon: Clock, title: "الالتزام بالمواعيد", desc: "نحرص على إنجاز الأعمال في الوقت المتفق عليه مع المحافظة على جودة التنفيذ." },
  { icon: Wrench, title: "معاينة مجانية", desc: "نوفر معاينة ميدانية ورفع مقاسات للمساعدة في اختيار الحل المناسب قبل التنفيذ." },
...
const FAQ = [
  { q: "ما هو الزجاج السيكوريت؟", a: "الزجاج السيكوريت هو زجاج معالج حراريًا يتميز بمقاومة أعلى للصدمات مقارنة بالزجاج العادي، ويستخدم في الواجهات الزجاجية، والأبواب، وكبائن الشاور، والدرابزين لما يوفره من متانة ومستوى أمان مرتفع." },
  { q: "هل توفرون معاينة ورفع مقاسات؟", a: "نعم، نوفر معاينة ميدانية ورفع مقاسات لمساعدتك في اختيار الحل المناسب وتقديم عرض سعر واضح قبل بدء التنفيذ." },
  { q: "كم تستغرق مدة التنفيذ؟", a: "تختلف مدة التنفيذ حسب نوع المشروع وحجمه، ويتم تحديدها بعد المعاينة ورفع المقاسات، مع توضيح المدة المتوقعة قبل بدء العمل." },
  { q: "هل تقدمون ضمانًا على الأعمال؟", a: "نحرص على تنفيذ الأعمال بجودة عالية، ويتم توضيح تفاصيل الضمان المتاح حسب نوع المشروع والمواد المستخدمة قبل التنفيذ." },
  { q: "ما المدن التي تخدمونها؟", a: "نقدم خدمات تفصيل وتركيب الزجاج السيكوريت في الدمام، والخبر، والظهران، والقطيف، والجبيل، والمناطق المجاورة." },
];
      ...
      <div className="mx-auto max-w-7xl grid gap-12 lg:grid-cols-2 items-center">
        <motion.div {...fadeUp()}>
          ...
          <p className="mt-6 text-white/70 leading-loose">
            <strong className="text-white">الرواد للزجاج</strong> شركة متخصصة في تفصيل وتركيب الزجاج السيكوريت بالمنطقة الشرقية، نقدم حلولًا متكاملة للمنازل والمنشآت التجارية تشمل الواجهات الزجاجية، وأبواب السيكوريت، وكبائن الشاور، والدرابزين، والمرايا. نحرص على دقة القياس، وجودة التنفيذ، واختيار المواد المناسبة لتقديم أعمال تجمع بين المتانة والتصميم العصري.
          </p>
        ...
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-display font-extrabold text-white text-lg text-gold-gradient">الرواد</div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><a href="#services" className="hover:text-[color:var(--gold)] transition-colors">خدماتنا</a></li>
              <li><a href="#projects" className="hover:text-[color:var(--gold)] transition-colors">أعمالنا</a></li>
              <li><a href="#process" className="hover:text-[color:var(--gold)] transition-colors">خطوات العمل</a></li>
              <li><a href="#about" className="hover:text-[color:var(--gold)] transition-colors">من نحن</a></li>
              <li><a href="#faq" className="hover:text-[color:var(--gold)] transition-colors">الأسئلة الشائعة</a></li>
            </ul>
          </div>
