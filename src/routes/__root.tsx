...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "الرواد للزجاج السيكوريت" },
      { property: "og:title", content: "الرواد للزجاج السيكوريت" },
      { name: "twitter:title", content: "الرواد للزجاج السيكوريت" },
      { name: "description", content: "Elegant Glass Solutions provides a premium Arabic website for Al-Ruwaad for Security Glass, showcasing their specialized glass services." },
      { property: "og:description", content: "Elegant Glass Solutions provides a premium Arabic website for Al-Ruwaad for Security Glass, showcasing their specialized glass services." },
      { name: "twitter:description", content: "Elegant Glass Solutions provides a premium Arabic website for Al-Ruwaad for Security Glass, showcasing their specialized glass services." },
