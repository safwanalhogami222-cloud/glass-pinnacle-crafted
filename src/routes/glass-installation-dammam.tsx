...
const TITLE = "تركيب زجاج سيكوريت بالدمام | تفصيل وتركيب الزجاج";
const DESC =
  "تفصيل وتركيب زجاج سيكوريت بالدمام والخبر، أبواب زجاج، واجهات زجاج، درابزين، شاور زجاج ومرايا بأعمال احترافية.";

const URL = `${BASE_URL}/glass-installation-dammam`;

const FEATURES = [
  { icon: Award, t: "خبرة تفوق 15 عامًا", d: "فريق متخصص في أعمال الزجاج المقسّى بالدمام نفّذ مئات المشاريع السكنية والتجارية في المنطقة الشرقية." },
...
const FAQ = [
  {
    q: "ما تكلفة تفصيل وتركيب الزجاج المقسّى في الدمام؟",
  ...
  return (
    <>
      <PageHero
        ...
        goldTitle="بالدمام"
        desc="تفصيل وتركيب زجاج سيكوريت في الدمام والخبر: أبواب زجاج، واجهات زجاج، درابزين، شاور زجاج ومرايا — بمعايير احترافية وضمان، مع معاينة مجانية."
        image={heroImg}
        imageAlt="تركيب واجهة زجاج سيكوريت لمحل تجاري بالدمام بتنفيذ الرواد للزجاج السيكوريت"
      />
          ...
          <div>
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              <h2 className="section-title">
                خدمات <span className="text-gold-gradient">تركيب الزجاج بالدمام</span>
              </h2>
              <div className="mt-4 space-y-4 text-muted-foreground leading-loose">
                <p>
                  تُعد مؤسسة {BRAND} من أبرز الجهات المتخصصة في تفصيل وتركيب الزجاج بالدمام والخبر، حيث نقدم خدمة متكاملة تبدأ من الاستشارة وأخذ المقاسات على الطبيعة،
                  وتمر بمرحلة التفصيل في ورشتنا المجهزة، وتنتهي بالتركيب النهائي والتلميع وتسليم الموقع نظيفًا. سواء كنت تبحث عن زجاج سيكوريت لفيلا سكنية،
                  أو محل تجاري، أو مكتب، فإننا نوفر لك الحل الزجاجي المناسب بجودة عالية وأسعار شفافة.
                </p>
                <p>
                  نركّز في أعمالنا على الزجاج المقسّى (السيكوريت) لأنه الخيار الأمثل لمناخ المنطقة الشرقية؛ فهو يتحمل ارتفاع درجات الحرارة والرطوبة العالية والفروقات
                  الحرارية بين الداخل والخارج، ويوفر في الوقت نفسه مستوى أمان عاليًا للمنازل والمنشآت التجارية. وكمحل زجاج ومرايا متكامل، نغطي كافة احتياجاتك من
                  التفصيل حتى التركيب والتسليم جاهزًا للاستخدام.
                </p>
              </div>

              <h2 className="mt-12 section-title">
                تفصيل وتركيب <span className="text-gold-gradient">زجاج سيكوريت</span>
              </h2>
              <div className="mt-4 space-y-4 text-muted-foreground leading-loose">
                <p>
                  يبدأ عملنا بتفصيل زجاج دقيق يعتمد على مقاسات حقيقية مأخوذة من الموقع. لا نعتمد على التقديرات، بل نقوم بزيارة المعاينة بشكل مجاني داخل الدمام والخبر
                  والقطيف والظهران والجبيل، ونرسم كل لوح على حدة مع مراعاة الفتحات والثقوب والزوايا غير القياسية. بعد ذلك يتم نقل المقاسات إلى الورشة حيث يتم قص الزجاج
                  المقسّى وتقسيته حسب المواصفات العالمية.
                </p>
                <p>
                  مرحلة التركيب تتم على يد فنيين متخصصين يملكون خبرة طويلة في التعامل مع الزجاج السيكوريت، مع استخدام إكسسوارات أصلية من ماركات عالمية
                  لضمان ثبات الأبواب وسلاسة حركتها. نلتزم بثلاث قواعد أساسية في كل مشروع: الدقة في المقاس، وشفافية السعر، والالتزام بالموعد. بعد الانتهاء، نرسل للعميل
                  عرض سعر مكتوب يوضح كل بند: الزجاج، الإكسسوارات، التركيب، ومدة التنفيذ، ثم نبدأ العمل فور الموافقة.
                </p>
              </div>

              <h2 className="mt-12 section-title">
                أبواب وواجهات <span className="text-gold-gradient">الزجاج</span>
              </h2>
              <div className="mt-4 space-y-4 text-muted-foreground leading-loose">
                <p>
              ...
              <h2 className="mt-12 section-title">
                درابزين زجاج <span className="text-gold-gradient">وزجاج الشاور</span>
              </h2>
              <div className="mt-4 space-y-4 text-muted-foreground leading-loose">
                <p>
                  إذا كنت تبحث عن <Link to="/glass-railings-dammam" className="text-[color:var(--gold)] underline decoration-[color:var(--gold)]/40 hover:decoration-[color:var(--gold)]">درابزين زجاج بالدمام</Link>، فنحن نقدم حلولًا مخصصة للأدراج والشرفات والبلكونات باستخدام زجاج مصفح ومقسّى وقواعد ستانلس ستيل 316
                  مقاومة للصدأ. الدرابزين الزجاجي يمنح المكان إحساسًا بالاتساع ويحفظ الإطلالة مع الحفاظ على معايير السلامة، وهو خيار مثالي للفلل والمكاتب
                  والمباني التجارية التي تبحث عن لمسة عصرية.
                </p>
                <p>
                  وفي القسم السكني، يمثّل <Link to="/services/$slug" params={{ slug: "shower-glass" }} className="text-[color:var(--gold)] underline decoration-[color:var(--gold)]/40 hover:decoration-[color:var(--gold)]">زجاج الشاور</Link> واحدًا من أكثر الأعمال المطلوبة لدينا. ننفذ قواطع الشاور بدون إطار (Frameless) بمقاسات مخصصة لكل حمام، مع
                  إكسسوارات كروم أو ذهبي أو أسود مطفي، ومعالجة نانو للزجاج تقلل ترسبات الماء والجيرية وتجعل التنظيف أسهل بكثير. جميع أعمال الشاور والدرابزين
                  تُنفّذ بدقة عالية وتنتهي باختبار نهائي للتأكد من سلامة التركيب.
                </p>
              </div>

              <div className="mt-6 rounded-2xl border border-[color:var(--gold)]/30 bg-card p-5">
                <h3 className="font-bold mb-2">بحاجة إلى حماية وأناقة للأدراج أو الشرفات؟</h3>
                <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                  اكتشف حلول <Link to="/glass-railings-dammam" className="text-[color:var(--gold)] underline decoration-[color:var(--gold)]/40 hover:decoration-[color:var(--gold)]">درابزين زجاج بالدمام</Link> المصممة حسب موقعك بمواد مقاومة للصدأ وزجاج مقسّى يتوافق مع معايير السلامة.
                </p>
                <Link to="/glass-railings-dammam" className="inline-flex items-center gap-1.5 text-sm font-bold text-[color:var(--gold)] hover:underline">
                  تصفح درابزين زجاج بالدمام <ArrowLeft className="h-3.5 w-3.5" aria-hidden="true" />
                </Link>
              </div>
              ...
              <h2 className="mt-12 section-title">
                لماذا تختار <span className="text-gold-gradient">الرواد للزجاج السيكوريت؟</span>
              </h2>
