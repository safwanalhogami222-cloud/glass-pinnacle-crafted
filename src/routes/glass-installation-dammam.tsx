          ...
          <div>
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              ...
              <div className="mt-4 space-y-4 text-muted-foreground leading-loose">
                <p>
                  تُعد مؤسسة {BRAND} من أبرز الجهات المتخصصة في تركيب زجاج سيكوريت بالدمام والخبر، حيث نقدم خدمة متكاملة تبدأ من الاستشارة وأخذ المقاسات على الطبيعة،
                  وتمر بمرحلة التفصيل في ورشتنا المجهزة، وتنتهي بالتركيب النهائي والتلميع وتسليم الموقع نظيفًا. سواء كنت تبحث عن تركيب زجاج بالدمام لفيلا سكنية،
                ...
                <p>
                  ...
                  تفصيل الزجاج حتى تركيبه وتسليمه جاهزًا للاستخدام.
                </p>
              </div>
              ...
              <div className="mt-4 space-y-4 text-muted-foreground leading-loose">
                <p>
                  ...
                  السيكوريت وتقسيته حسب المواصفات العالمية.
                </p>
                <p>
                  مرحلة تركيب زجاج سيكوريت تتم على يد فنيين متخصصين يملكون خبرة طويلة في التعامل مع الزجاج المقسّى، مع استخدام إكسسوارات أصلية من ماركات عالمية
